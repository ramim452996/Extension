<?php
if (!function_exists('__4864a3df76f7560e4fc5a15ad87d503d')):
function __4864a3df76f7560e4fc5a15ad87d503d($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrs4ae9ecb9fa743b5d80c0142ccff73d64 = ['content' => $tooltip,'position' => $tooltipPosition,'kbd' => $tooltipKbd]; ?>
...
<?php ob_start(); ?>
    ...
    <?php $__slots4ae9ecb9fa743b5d80c0142ccff73d64['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots4ae9ecb9fa743b5d80c0142ccff73d64); ?>
<?php __4ae9ecb9fa743b5d80c0142ccff73d64($__blaze, $__attrs4ae9ecb9fa743b5d80c0142ccff73d64, $__slots4ae9ecb9fa743b5d80c0142ccff73d64, ['content', 'position', 'kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH C:\Users\RAMIM\Herd\compare-backend\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/collapse.blade.php ENDPATH**/ ?>