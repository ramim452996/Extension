<?php
if (!function_exists('__64d548775454e9936623e1d697f66b88')):
function __64d548775454e9936623e1d697f66b88($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($collapsibleOnMobile): ?>
    <?php if (!function_exists('__7d592aff7a633cd62e19136fe15b39a5')) { $__blaze->compile('C:\Users\RAMIM\Herd\compare-backend\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/7d592aff7a633cd62e19136fe15b39a5.php'); require $__blaze->compiledPath.'/7d592aff7a633cd62e19136fe15b39a5.php'; } ?>
<?php $__blaze->pushData([]); ?>
<?php __7d592aff7a633cd62e19136fe15b39a5($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
<?php endif; ?>
...
} endif; ?><?php /**PATH C:\Users\RAMIM\Herd\compare-backend\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/index.blade.php ENDPATH**/ ?>