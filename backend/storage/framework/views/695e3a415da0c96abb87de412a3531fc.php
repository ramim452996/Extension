<?php # [BlazeFolded]:{flux::icon.check}:{C:\Users\RAMIM\Herd\compare-backend\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/check.blade.php}:{1788752026} ?>
<?php # [BlazeFolded]:{flux::icon.minus}:{C:\Users\RAMIM\Herd\compare-backend\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/minus.blade.php}:{1788752026} ?>
<?php
if (!function_exists('_695e3a415da0c96abb87de412a3531fc')):
function _695e3a415da0c96abb87de412a3531fc($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH C:\Users\RAMIM\Herd\compare-backend\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/indicator.blade.php ENDPATH**/ ?>